...
## Data
The data for this task consists of pairs of words <img src="https://render.githubusercontent.com/render/math?math=$\left\{\left(s^{(i)}, t^{(i)}\right)\right\}_{i=1}^{N}$> where the *source* $s^{(i)}$
